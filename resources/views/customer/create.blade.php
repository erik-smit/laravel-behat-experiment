    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('customer') }}" aria-label="{{ __('Register') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="contactmail" type="email" class="form-control{{ $errors->has('contactmail') ? ' is-invalid' : '' }}" name="contactmail" value="{{ old('contactmail') }}" required>
