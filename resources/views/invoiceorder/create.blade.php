    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('invoiceorder') }}" aria-label="{{ __('Register') }}">
                        @csrf
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-9">
                                <input id="product" type="text" class="form-control{{ $errors->has('product[]') ? ' is-invalid' : '' }}" name="product[]" value="{{ old('product[]') }}" autofocus>
